                    ...
                    <div className="character-form">
                        ...
                        <label className="inline-setting">
                            <input
                                ...
                                onChange={(event) =>
                                    updateGroup({
                                        ...group,
                                        allowSelfResponses: event.currentTarget.checked,
                                    })
                                }
                            />
                        ...
                        <section className="group-panel-section">
                            ...
                            <label className="inline-setting">
                                <input
                                    type="checkbox"
                                    checked={group.autoResponses?.enabled === true}
                                    onChange={(event) =>
                                        updateGroup({
                                            ...group,
                                            autoResponses: {
                            ...
                            {members.length < 2 &&
                                ...
                                group.allowSelfResponses !== true && (
                                    <p className="field-hint">
                                        Automatic responses need at least two unmuted
                                        members unless self responses are enabled.
                                    </p>
                                )}
                                    ...
                                    onInput={(event) =>
                                        updateGroup({
                                            ...
                                            autoResponses: {
                                                ...defaultAutoResponses(),
                                                ...group.autoResponses,
                                                chance: Number(event.currentTarget.value),
                                            },
                                        })
                                    }
                                />
                            ...
                            <div className="character-meta-grid">
                                ...
                                <label>
                                    ...
                                    <input
                                        ...
                                        max="10000"
                                        step="100"
                                        value={group.autoResponses?.delayMs ?? 900}
                                        onInput={(event) =>
                                            updateGroup({
                                                ...group,
                                                autoResponses: {
                                ...
                                {members.map((member, index) => (
                                    ...
                                    >
                                        <img
                                            ...
                                            src={
                                                member.avatarPath ||
                                                characterInitialAvatar(member.name)
                                            }
                                            alt=""
                                        />
                                        <span>
                                        ...
                                        <label className="group-talkativeness">
                                            ...
                                            <input
                                                ...
                                                max="1"
                                                step="0.05"
                                                value={member.talkativeness ?? 0.5}
                                                onInput={(event) =>
                                                    updateMember(member.characterId, {
                        ...
                        <label>
                            ...
                            <select
                                ...
                                onChange={(event) => addMember(event.currentTarget.value)}
                            >
                                <option value="">
