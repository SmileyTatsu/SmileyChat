...
These macros provide access to the current chat session's flow. Note: To prevent accidental macro injections by the AI or user text, the contents returned by these macros are intentionally _not_ recursively evaluated.
