...
*Note: Generation behaviors like `temperature`, `top_p`, or `max_tokens` are saved within **Presets**, not Connections. Connections are strictly for routing, URLs, and authentication.*