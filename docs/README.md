...
This folder contains user guides, reference material, plugin documentation, and developer notes for SmileyChat.

## Start Here

- [Running SmileyChat on Android via Termux](android-termux.md)
