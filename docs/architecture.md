...
6. **Adapter Generation**: The context is sent to the configured `ConnectionAdapter` (e.g., OpenAI-compatible). The adapter is responsible for handling the HTTP request.
