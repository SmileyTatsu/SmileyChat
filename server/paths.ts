...
export const lorebookIndexPath = join(userDataDir, "lorebooks", "index.json");
export const lorebookBooksDir = join(userDataDir, "lorebooks", "books");
export const lorebookImportsDir = join(userDataDir, "lorebooks", "imports");
export const lorebookOrphanedDir = join(userDataDir, "lorebooks", "orphaned");
export const instructDir = join(userDataDir, "instruct");
export const instructTemplatesPath = join(userDataDir, "instruct", "templates.json");
